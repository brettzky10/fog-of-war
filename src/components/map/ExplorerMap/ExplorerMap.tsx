...
import { useAssetSetup, useMapCanvas, usePlayerMovement } from '@/lib/hooks/customHooks';
import { CanvasRef, StageRef } from '@/lib/model/customTypes.model';
...
export interface ExplorerMapProps {
  mapSrc: HTMLImageElement['src']; //mapSrc: string | StaticImageData
}
